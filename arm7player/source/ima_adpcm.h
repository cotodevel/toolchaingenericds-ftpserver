...
#define lBufferARM7 (s16*)((int)0x037f8000)		//First 32K as adpcm decoder workspace
#define rBufferARM7 (s16*)((int)0x037f8000 + (ADPCM_SIZE*8))
...
public:
	...
	int play(bool loop_audio, bool automatic_updates, int buffer_length = ADPCM_SIZE*2, closeSoundHandle = NULL);
	void pause();
	void resume();
	void stop();
